...
Los datos que he utilizado estaban contenidos en 3 tablas, dos de ellas "Registro_regional_de_sida" y "Registro_nuevas_infecciones_por_vih" provienen de la sección de datos abiertos página de la [Junta de Castilla y León](https://datosabiertos.jcyl.es/web/es/datos-abiertos-castilla-leon.html).

#### registro_regional_de_sida

Esta tabla contiene el Sexo, Provincia, País, Edad, Código, Grupo de riesgo y Año de diagnóstico del VIH a personas entre 1985 y 2009.
...
summary(registro_regional_de_sida)
```

#### registro_nuevas_infecciones_por_vih

En este conjunto de datos obtenemos unos datos bastante similares a los anteriores, Sexo, Provincia, País, Edad, Código y Grupo de riesgo y Año de diagnóstico entre otros, del VIH a personas entre 2009 y 2021.
...
summary(registro_nuevas_infecciones_por_vih)
```
La última tabla la he obtenido a través de un repositorio de GitHub, creado para que la gente pueda usar libremente los datos abiertos de [AEMET](https://opendata.aemet.es/centrodedescargas/inicio) con una guía para instalar los paquetes de datos en Rstudio, que podéis visitar a través de [aquí](https://github.com/rOpenSpain/climaemet). 
```{r, warning = FALSE, message = FALSE}
...
```{r}
data_daily <-
  aemet_daily_clim(station, start = "1982", end = "2021")
